...
const verifiedAppetiteRecords: AppetiteRecord[] = [
  ...
  // ---------------------------------------------------------------------------------------
  {
    ...
    marketType: 'mga',
    states: u('Cover Whale publishes admitted/non-admitted availability by state, and it is coverage-specific — the Auto Liability state list is not yet captured in RenewalIQ.'),
    ...
    dotNumberRequired: u(),
    majorExclusions: u('Cover Whale publishes excluded trucking classes/operations; the specific list is not yet captured in RenewalIQ.'),
