...
export const distributionPartners: DistributionPartner[] = [
  ...
  { id: 'dist_rps', name: 'RPS', kind: 'mga_wholesaler', sourceNotes: 'Wholesale MGA distributing a broad list of trucking markets across most coverage lines. Internal market list, not independently verified.' },
